...
1. **[CODEOWNERS](https://github.com/mohiddin-data/data_engineering_project_template/blob/main/.github/CODEOWNERS)**: In this file change the user id from `@mohiddin-data` to your Github user id.
